...
'
echo " " 
echo -e "$red                       ▶Coded by$grn alka adulto$red◀$rset"
echo -e "$red                      ⫸$ylo  ABTIN baalberith$red ⫷$rset"
echo 
# Functions
...
echo " "
echo " "
echo -e "$red                        ➡$cyan [\e[92m1\e[96m] new rat"
echo -e "$red                        ➡$cyan [\e[92m2\e[96m] sev rat"
echo -e "$red                        ➡$cyan [\e[92m3\e[96m] dar bareh ma"
echo -e "$red                        ➡$cyan [\e[92m4\e[96m] Update termux"
echo -e "$red                        ➡$cyan [\e[92m5\e[96m] i robika man"
echo -e "$red                        ➡$cyan [\e[92m6\e[96m] i patogh man"
echo -e "$red                        ➡$cyan [\e[92m7\e[96m] i talgram man"
...
then
am start -a android.intent.action.VIEW -d https://rubika.ir/CODER_Alka/nhytchannel > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
am start -a android.intent.action.VIEW -d https://patogh.me/coder_alka/noobspage > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
am start -a android.intent.action.VIEW -d https://t.me/ALKA_ADULTO > /dev/null 2>&1
banner
menu
elif [ $optnz = "8" ];
then
...
echo -e "\e[93m        MY WEBSITE:\e[92m https.me/CODER_ALKA\e[0m" | pv -qL 10
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://t.me/ALKA_ADULTO 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
